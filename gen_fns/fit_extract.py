...
def plot_fit_files(field, ids):
    ...
    for source_id in ids:
        ...
        if field == 'cdfs':
            file_path = f'/Users/jess/Desktop/git_mphil/spectra/{field}_fast.zip/{field}.v1.6.9_{source_id}.fit'

        elif field == 'cosmos':
            file_path = f'/Users/jess/Desktop/git_mphil/spectra/{field}_fast.zip/{field}.v1.3.6_{source_id}.fit'

        elif field == 'uds':
            file_path = f'/Users/jess/Desktop/git_mphil/spectra/{field}_fast.zip/{field}.v1.5.8_{source_id}.fit'
