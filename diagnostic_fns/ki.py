...
def ki(datasets, xd, yd, masks = None, save_path = None, dataset_names = None, colour_bar = None):
    ...
    for i, (ax, df, dataset_name) in enumerate(zip(axs, datasets, dataset_names)):
        ...
        ax.set_xticks(np.arange(-1.5, 2.5, 1.0)); ax.set_yticks(np.arange(-2, 2, 1.0))
